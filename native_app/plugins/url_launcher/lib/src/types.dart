...
typedef AppControlSetAppIdFunc = Int32 Function(AppControlHandle, Pointer<Utf8>);
typedef AppControlAddExtraDataFunc = Int32 Function(AppControlHandle, Pointer<Utf8>, Pointer<Utf8>);
...
typedef AppControlSetAppId = int Function(AppControlHandle, Pointer<Utf8>);
typedef AppControlAddExtraData = int Function(AppControlHandle, Pointer<Utf8>, Pointer<Utf8>);
